...
public:
    ...
    bool render(Scene *scene, RenderQueue *queue, const RenderJob *job,
        ...
        while(true) {
            ...
            prepareDataForSolver(1.f, &imgfIter[0], dataImg, len, NULL, 0);
            ...
            if(currentIteration % m_dumpIteration == 0) {
                ...
                if(m_config.m_reconstructL2) {
                    ...
                    if(m_config.m_reconstructL1) {
                        develop(scene, hdrFilm, recBuff, currentIteration, "_L2_");
                    } else {
                        develop(scene, hdrFilm, recBuff, currentIteration, "_recons_");
                    }
                ...
                if(m_config.m_reconstructL1) {
                    ...
                    if(m_config.m_reconstructL2) {
                        develop(scene, hdrFilm, recBuff, currentIteration, "_L1_");
                    } else {
                        develop(scene, hdrFilm, recBuff, currentIteration, "_recons_");
                    }
