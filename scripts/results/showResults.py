...
if __name__=="__main__":
    ...
    parser.add_option('-a','--basex', help="Base name file x", default="_time.csv")
    ...
    techniques = readAllTechniques(options.input, options.rep, step, options.log, options.basex, options.basey)
