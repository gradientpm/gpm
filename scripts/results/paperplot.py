...
if __name__=="__main__":
    ...
    parser.add_option('-g','--addgbdpt', help='Add GBDPT curve', default=False, action="store_true")
    ...
    algorithms = [ AlgorithmPlot("Hachisuka and Jensen [2009]",
                                 "SPPM",
                                 "go-", (56,53,238)),
                   AlgorithmPlot("Our method L1",
                                 "GPM_L1",
                                 "rv-",
                                 (238,53,56)),
                   AlgorithmPlot("Our method L2",
                                 "GPM_L2",
                                 "rv-",
                                 (0,219,56))
                  ]
    ...
    if(opts.addgbdpt):
        algorithms.append(
        AlgorithmPlot("Manzi et al. [2015]",
                      "GBDPT_L1_recons,GBDPT_L1", # Use another file for the time information
                      "b^-",
                      (232,183,14),
                      False # Not in focus
                      ))
    ...
    minyvalue = 0.0001
    maxyvalue = maxyvalueFocus = 10.0
    yAxis = [0.0001, 0.001, 0.01, 0.1, 1.0, 10.0]
